...
case class Rule4Group(id: Option[Int], comment: Option[String], from: String, to: String, applications: Option[Array[String]],
...
case class Group4Single(name: String,
                        comment: String,
                        domain: String,
                        learned: Boolean = false,
                        reserved: Boolean = false,
...
case class Group4SingleDTO(name: String,
                           comment: String,
                           domain: String,
                           learned: Boolean,
                           reserved: Boolean,
