...
object ContainerConfigJsonProtocol extends DefaultJsonProtocol {
  ...
  implicit val quarantineConfigFormat: RootJsonFormat[QuarantineConfig] = jsonFormat1(QuarantineConfig)
  implicit val quarantineConfigWarpFormat: RootJsonFormat[QuarantineConfigWarp] = jsonFormat1(QuarantineConfigWarp)
  implicit val snifferParamFormat: RootJsonFormat[SnifferParam] = jsonFormat3(SnifferParam)
  implicit val snifferParamWrapFormat: RootJsonFormat[SnifferParamWarp] = jsonFormat1(SnifferParamWarp)
