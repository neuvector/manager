...
export class GroupJsonProtocol {
  ...
  public ops: ReadonlyArray<string> = [ this.equalOp, this.notEqualOp, this.containsOp, this.prefixOp, this.regexOp, this.notRegexOp ];
...
export const GroupJsonProtocolInhabitant: GroupJsonProtocol = GroupJsonProtocol.getInstance();
