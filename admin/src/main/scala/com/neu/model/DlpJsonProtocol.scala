...
object DlpJsonProtocol extends DefaultJsonProtocol {
  ...
  implicit val dlpGroupConfigDataFmt: RootJsonFormat[DlpGroupConfigData] = jsonFormat1(
    DlpGroupConfigData
  )
  ...
  implicit val dlpSensorConfigDataFmt: RootJsonFormat[DlpSensorConfigData] = jsonFormat1(
    DlpSensorConfigData
  )
