...
object AdmissionJsonProtocol extends DefaultJsonProtocol {
  implicit val admissionRuleSubCriterionFormat: RootJsonFormat[AdmRuleSubCriterion] = jsonFormat3(AdmRuleSubCriterion)
  implicit val admissionRuleCriterionFormat: RootJsonFormat[AdmRuleCriterion] = jsonFormat4(AdmRuleCriterion)
  ...
  def admissionRuleCriterionToJson(admissionRuleCriterion: AdmRuleCriterion): String = admissionRuleCriterion.toJson.compactPrint
  def admissionRuleToJson(admissionRule: AdmRule): String = admissionRule.toJson.compactPrint
  def admissionRuleConfigToJson(admissionRuleConfig: AdmRuleConfig): String = admissionRuleConfig.toJson.compactPrint
