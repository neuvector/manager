...
case class ServiceLevelConversationWrap(
  ...
  object DashboardJsonProtocol extends DefaultJsonProtocol with LazyLogging {
    ...
    implicit val violationEndpointFormat: RootJsonFormat[ViolationEndpoint] = jsonFormat21(ViolationEndpoint)
    ...
    implicit val incidentEndpointFormat: RootJsonFormat[IncidentEndpoint] = jsonFormat2(IncidentEndpoint)
    ...
    implicit val criticalSecurityEventDTOFormat: RootJsonFormat[CriticalSecurityEventDTO] = jsonFormat4(CriticalSecurityEventDTO)

    implicit val workloadsStatusFormat: RootJsonFormat[WorkloadsStatus] = jsonFormat6(WorkloadsStatus)
    implicit val workloadsChildrenFormat: RootJsonFormat[WorkloadsChildren] = jsonFormat8(WorkloadsChildren)
    implicit val workloadsFormat: RootJsonFormat[Workloads] = jsonFormat10(Workloads)
    implicit val vulnerableContainerEndpointFormat: RootJsonFormat[VulnerableContainerEndpoint] = jsonFormat3(VulnerableContainerEndpoint)
    implicit val nodeScanSummaryFormat: RootJsonFormat[ScanSummary4Dashboard] = jsonFormat3(ScanSummary4Dashboard)
    ...
    implicit val vulnerablePlatformsFormat: RootJsonFormat[VulnerablePlatforms] = jsonFormat2(VulnerablePlatforms)
    implicit val vulnerableNodesFormat: RootJsonFormat[VulnerableNodes] = jsonFormat2(VulnerableNodes)
    implicit val vulnerableNodeEndpointFormat: RootJsonFormat[VulnerableNodeEndpoint] = jsonFormat2(VulnerableNodeEndpoint)

    implicit val IncidentsFormat: RootJsonFormat[Incidents] = jsonFormat10(Incidents)
    implicit val IncidentsEndpointFormat: RootJsonFormat[IncidentsEndpoint] = jsonFormat2(IncidentsEndpoint)
    ...
    implicit val threatDetailsDataFormat: RootJsonFormat[ThreatDetailsData] = jsonFormat1(ThreatDetailsData)

    implicit val violationMajorFormat: RootJsonFormat[ViolationMajor] = jsonFormat14(ViolationMajor)
    implicit val violationDetailsFormat: RootJsonFormat[ViolationDetails] = jsonFormat8(ViolationDetails)
    implicit val violationMajorDataFormat: RootJsonFormat[ViolationMajorData] = jsonFormat1(ViolationMajorData)
    implicit val violationDetailsDataFormat: RootJsonFormat[ViolationDetailsData] = jsonFormat1(ViolationDetailsData)

    implicit val incidentMajorFormat: RootJsonFormat[IncidentMajor] = jsonFormat18(IncidentMajor)
    implicit val incidentDetailsFormat: RootJsonFormat[IncidentDetails] = jsonFormat14(IncidentDetails)
    implicit val incidentMajorDataFormat: RootJsonFormat[IncidentMajorData] = jsonFormat1(IncidentMajorData)
    implicit val incidentDetailsDataFormat: RootJsonFormat[IncidentDetailsData] = jsonFormat1(IncidentDetailsData)
    ...
    implicit val securityEventDTOFormat: RootJsonFormat[SecurityEventDTO] = jsonFormat1(SecurityEventDTO)
    ...
    implicit val applicationsInPolicyFormat: RootJsonFormat[ApplicationsInPolicy] = jsonFormat4(ApplicationsInPolicy)
    implicit val applicationsInPolicyWrapFormat: RootJsonFormat[ApplicationsInPolicyWrap] = jsonFormat2(ApplicationsInPolicyWrap)
    ...
    implicit val serviceLevelConversationFormat: RootJsonFormat[ServiceLevelConversation] = jsonFormat13(ServiceLevelConversation)
    implicit val serviceLevelConversationWrapFormat: RootJsonFormat[ServiceLevelConversationWrap] = jsonFormat14(ServiceLevelConversationWrap)
    implicit val exposedConversationsFormat: RootJsonFormat[ExposedConversations] = jsonFormat2(ExposedConversations)
    implicit val applicationAnalysisFormat: RootJsonFormat[ApplicationAnalysis] = jsonFormat2(ApplicationAnalysis)
    ...
    implicit val admissionRulesWrapFormat: RootJsonFormat[AdmissionRulesWrap] = jsonFormat2(AdmissionRulesWrap)
    implicit val admissionStateFormat: RootJsonFormat[AdmissionState] = jsonFormat1(AdmissionState)
    implicit val admissionStateWrapFormat: RootJsonFormat[AdmissionStateWrap] = jsonFormat2(AdmissionStateWrap)
    ...
    implicit val conversationOutputFormat: RootJsonFormat[ConversationOutput] = jsonFormat6(ConversationOutput)
    implicit val vulContainerOutputFormat: RootJsonFormat[VulContainerOutput] = jsonFormat4(VulContainerOutput)
    implicit val vulNodeOutputFormat: RootJsonFormat[VulNodeOutput] = jsonFormat3(VulNodeOutput)
    implicit val vulPlatformOutputFormat: RootJsonFormat[VulPlatformOutput] = jsonFormat2(VulPlatformOutput)
    implicit val policyOutputFormat: RootJsonFormat[PolicyOutput] = jsonFormat2(PolicyOutput)

    //Scoring
    //=========================================
    implicit val vulnerabilityCountFormat: RootJsonFormat[VulnerabilityCount] = jsonFormat2(VulnerabilityCount)
    implicit val vulnerabilityExploitRiskFormat: RootJsonFormat[VulnerabilityExploitRisk] = jsonFormat9(VulnerabilityExploitRisk)
    implicit val serviceConnectionRiskFormat: RootJsonFormat[ServiceConnectionRisk] = jsonFormat3(ServiceConnectionRisk)
    implicit val ingressEgressRiskFormat: RootJsonFormat[IngressEgressRisk] = jsonFormat5(IngressEgressRisk)
    implicit val workloadChildrenFormat: RootJsonFormat[WorkloadChildren] = jsonFormat5(WorkloadChildren)
    implicit val workloadFormat: RootJsonFormat[Workload] = jsonFormat10(Workload)
    implicit val vulnerableContainersFormat: RootJsonFormat[VulnerableContainers] = jsonFormat3(VulnerableContainers)
    implicit val vulnerabilitiesDTOFormat: RootJsonFormat[VulnerabilitiesDTO] = jsonFormat2(VulnerabilitiesDTO)
    ...
    implicit val dashboardNotificationDTOFormat: RootJsonFormat[DashboardNotificationDTO] = jsonFormat2(DashboardNotificationDTO)
    ...
    implicit val dashboardScoreDTO2Format: RootJsonFormat[DashboardScoreDTO2] = jsonFormat7(DashboardScoreDTO2)
    implicit val multiClusterSummaryFormat: RootJsonFormat[MultiClusterSummary] = jsonFormat2(MultiClusterSummary)
    ...
    def internalSystemDataToJson(internalSystemData: InternalSystemData): String = internalSystemData.toJson.compactPrint
    ...
    def violationsToConvertedviolations: (ViolationEndpoint) => ViolationEndpoint =
      (violation: ViolationEndpoint) => {
        violation.copy(
          client_name = if (!violation.client_name.isEmpty()) violation.client_name
          else if (!violation.client_ip.isEmpty()) violation.client_ip
          else violation.client_id,
          server_name = if (!violation.server_name.isEmpty()) violation.server_name
