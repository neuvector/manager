export class PathConstant {
  ...
  public static GROUP_URL = 'group'; //policy
  public static SERVICE_URL = 'service'; //policy
  public static PROCESS_PROFILE_URL = 'processProfile'; //policy
  public static FILE_PROFILE_URL = 'fileProfile'; //policy
  public static FILE_PREDEFINED_PROFILE_URL = 'filePreProfile'; //policy
  public static POLICY_URL = 'policy'; //policy
  public static POLICY_APP_URL = 'policy/application'; //policy
  public static POLICY_RULE_URL = 'policy/rule'; //policy
