...
export interface VulContainerOutput {
  criticalVulsMap: { [key: string]: number };
...
export function isVulContainerOutput(v: any): v is VulContainerOutput {
  return (
    typeof v['criticalVulsMap'] == 'object' &&
    Object.keys(v['criticalVulsMap']).every(
      key =>
        typeof key === 'string' && typeof v['criticalVulsMap'][key] === 'number'
    ) &&
