...
import { CriticalSecurityEventDTO, isCriticalSecurityEventDTO } from './CriticalSecurityEventDTO';
...
export function isDashboardDTO(v: any): v is DashboardDTO {
  return (
    (v['highPriorityVulnerabilities'] && isVulnerabilitiesDTO(v['highPriorityVulnerabilities'])) &&
    (v['criticalSecurityEvents'] && isCriticalSecurityEventDTO(v['criticalSecurityEvents'])) &&
    ((v['topIncidents'] && isError(v['topIncidents'])) || (v['topIncidents'] && isTopIncidentsDTO(v['topIncidents']))) &&
