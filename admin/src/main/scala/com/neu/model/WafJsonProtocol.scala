...
object WafJsonProtocol extends DefaultJsonProtocol {
  ...
  implicit val wafGroupConfigDataFmt: RootJsonFormat[WafGroupConfigData] = jsonFormat1(WafGroupConfigData)
  ...
  implicit val wafSensorConfigDataFmt: RootJsonFormat[WafSensorConfigData] = jsonFormat1(WafSensorConfigData)
  implicit val wafRuleConfigFmt: RootJsonFormat[WafRuleConfig] = jsonFormat2(WafRuleConfig)
  implicit val wafRuleConfigDataFmt: RootJsonFormat[WafRuleConfigData] = jsonFormat1(WafRuleConfigData)
  implicit val exportedWafSensorListFmt: RootJsonFormat[ExportedWafSensorList] = jsonFormat1(ExportedWafSensorList)
