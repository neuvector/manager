...
object SystemConfigJsonProtocol extends DefaultJsonProtocol {
  ...
  implicit val registyHttpsProxyFormat: RootJsonFormat[RegistyHttpsProxy] = jsonFormat3(RegistyHttpsProxy)
  implicit val registyHttpProxyFormat: RootJsonFormat[RegistyHttpProxy] = jsonFormat3(RegistyHttpProxy)
  ...
  implicit val systemAtmoConfigFormat: RootJsonFormat[SystemAtmoConfig] = jsonFormat4(SystemAtmoConfig)
  implicit val systemConfig4DashboardFormat: RootJsonFormat[SystemConfig4Dashboard] = jsonFormat1(SystemConfig4Dashboard)
  implicit val systemConfigWrapFormat: RootJsonFormat[SystemConfigWrap] = jsonFormat4(SystemConfigWrap)
  ...
  implicit val webhookConfigWrapFormat: RootJsonFormat[WebhookConfigWrap] = jsonFormat1(WebhookConfigWrap)
  ...
  def webhookConfigWrapToJson(webhookConfigWrap: WebhookConfigWrap): String = webhookConfigWrap.toJson.compactPrint
