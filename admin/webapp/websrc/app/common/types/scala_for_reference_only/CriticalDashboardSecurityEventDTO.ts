...
export function isCriticalDashboardSecurityEventDTO(
  v: any
): v is CriticalDashboardSecurityEventDTO {
  return (
    ...
    v['top_security_events'] &&
    isTopSecurityEvent(v['top_security_events'])
  );
}
