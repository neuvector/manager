...
} from "@components/federated-policy-configuration/federated-config-form/federated-config-form.component";
...
export class FederatedPolicyConfigurationComponent implements OnInit, ComponentCanDeactivate {

  config!: FederatedConfiguration;
  refreshConfig$ = new Subject();
  @ViewChild(FederatedConfigFormComponent) fedConfigForm!: FederatedConfigFormComponent;
